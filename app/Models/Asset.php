 ...
 * @property string                     $category         The asset's category as an human-readable name.
 * @property string                     $category_icon    The asset's category Fork Awesome icon class.
 * @property string                     $cost             The asset's license as an SPDX identifier.
 * @property string                     $license_name     The asset's license as human-readable name.
 * @property int                        $support_level_id The asset's support level (see the `SUPPORT_LEVEL_*` constants).
 * @property string                     $support_level    The asset's support level as an human-readable name.
 ...
 * @property string                     $download_url     The asset's latest version download URL (for compatibility with the existing asset library API).
 * @property string                     $version_string   The asset's latest version's supported Godot minor version (e.g. "0.4.2", for compatibility with the existing asset library API).
 ...
 * @property string                     $score_color      The Tailwind CSS classes used to color the asset's score in templates.
